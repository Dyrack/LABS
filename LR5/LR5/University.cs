...
namespace LR3
{
    ...
    public class University
    {
        ...
        int nextNumber; //нестатическое поле для проставки номера зачетки для студента 

        //метод добавления нового студента в список студентов 
        //принимается на вход студент как параметр метода 
        public void Add(Student student)
        {
            //добавляемому студенту присваивается следующий номер зачетки 
        ...
        //метод поиска студента по номеру зачетки 
        public Student SearchByNumber(int number)
        {
            //циклом проходим по списку всех студентов 
            foreach (Student student in this.students)
            {
                //находим студента с заданным номером зачетки 
